<?php
namespace Demo\First\Console\Command\AddItem;

/**
 * Interceptor class for @see \Demo\First\Console\Command\AddItem
 */
class Interceptor extends \Demo\First\Console\Command\AddItem implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Demo\First\Model\ItemFactory $itemFactory)
    {
        $this->___init();
